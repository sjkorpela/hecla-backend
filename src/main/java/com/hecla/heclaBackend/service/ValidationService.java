...
public class ValidationService {
  ...
  public void validateDataTransferPerson(DataTransferPerson person) throws BadRequestException {
    ...
    if (person.fatherId() != null && !personExistsById(person.fatherId())) {
      throw new BadRequestException("Given father not found!");
    }

    if (person.motherId() != null && !personExistsById(person.motherId())) {
  ...
  public boolean personExistsById(int id) {
